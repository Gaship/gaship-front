...
@RequestMapping("members/{memberNo}/member-tag")
public class MemberTagController {
    ...
    public String memberTagDeleteAllAndAddAll(
        ...
        return "redirect:/members/{memberNo}/member-tag";
    }
    ...
    public String memberTagList(@PathVariable Integer memberNo,
                                Model model) {
        List<MemberTagCoreResponseDto> memberTags = memberTagService.findMemberTags(memberNo);
