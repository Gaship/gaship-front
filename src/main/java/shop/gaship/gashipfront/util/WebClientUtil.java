...
public class WebClientUtil<T> {
     ...
     * @return ResponseEntit  서버의 응답 값이 담긴 객체입니다.
     */
     ...
     * @param responseEntity  요청받는 객체 타입입니다.
     * @return ResponseEntity 서버의 응답 값이 담긴 객체입니다.
     */
     ...
     */
    private ResponseEntity<T> createMethod(Supplier<WebClient.RequestHeadersUriSpec<?>> restMethod,
                                           String urn,
     ...
     */
    private <U> ResponseEntity<T> createHasBodyMethod(
        Supplier<WebClient.RequestBodyUriSpec> restMethod, String urn,
        List<QueryParam> queryParams,
