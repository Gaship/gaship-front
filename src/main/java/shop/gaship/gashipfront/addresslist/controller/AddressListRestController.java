...
public class AddressListRestController {
    ...
    @GetMapping
    public PageResponse<AddressListResponseDto> addressLists(@AuthenticationPrincipal
                                                                 UserDetailsDto user,
                                                             Pageable pageable) {
        return addressListService.findAddressLists(Long.valueOf(user.getMemberNo()),
                pageable);
    }
