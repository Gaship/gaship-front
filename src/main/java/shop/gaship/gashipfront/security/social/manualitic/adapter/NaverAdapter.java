...
public interface NaverAdapter {
     ...
     *
     * @param uri naver의 access token을 받기위해서 webclient로 전송할 url이며
     *            내부에는 code, client_id, client_secret이 함께 있습니다.
     * @return naverAccessToken code값을 통해서 받아온 access token을
     *          NaverAccessToken 타입으로 반환한 값을 담는 변수입니다.
     * @author 최겸준
     */
